...
**区间 4~9 张（含封面）** —— 其中 **6~9 是小红书配图的平台偏好区**，短帖 4~5 张也正常；
平台硬上限 18 张。**这个区间只在 SKILL.md 第 2 步定义一次，别处一律引用**（曾经三处口径打架）。
页数由"切法"决定，**不随文章行数增长**：张数 ≈ 1（封面）+ 章节数，平均每节 < 400 汉字时两节并一页，
全篇 < 1.5k 汉字压到 4~5 张。228 行的文章是 7 张，1000 行的文章也是 8~9 张。
